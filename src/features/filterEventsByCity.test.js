...
defineFeature(feature, (test) => {
  test('When user hasn not searched for a city, show upcoming events from all cities.', ({
    given,
    when,
    then,
  }) => {
    let AppWrapper;
    given('user hasn not searched for any city', () => {});
    ...
    then(
      'the user should see the list of upcoming events.',
      () => {
        AppWrapper.update();
        expect(
  ...
  test('User should see a list of suggestions when they search for a city', ({
    ...
    when(
      'the user starts typing in the city textbox',
      () => {
  ...
  test('User can select a city from the suggested list', ({
    ...
    let AppWrapper;
    given(
      'user was typing “Berlin” in the city textbox',
      async () => {
